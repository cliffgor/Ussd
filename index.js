...
app.post(
  ...
  new AfricasTalking.USSD((params, next) => {
    ...
    if (params.text === "") {
      ...
      message =
        "Thank you for using Cross Farmers, a reply text will be sent to your mobile shortly with the prices \n";
      endSession = true;
    } else if (params.text === "2*1*3*2") {
      message =
        "Thank you for using Cross Farmers, a reply text will be sent to your mobile shortly with the prices \n";
      endSession = true;
      ...
      message =
        "Thank you for using Cross Farmers, your information has been sent to your nearing Agricultural Extension Office a text will be sent to your mobile shortly with the instructions on caring for your tomatoes";
      message += " \n";
      endSession = true;
    } else {
